...
class SeamFinder:
    ...
    def avg_x_range(self):
        ...
        i = max(1,self.previous_avg_x-int(self.image.w*self.accuracy//2))
        j = min(self.image.w-1,self.previous_avg_x+int(self.image.w*self.accuracy//2))
        k = max(j,self.image.w-2-int(self.image.w*self.accuracy//2))
